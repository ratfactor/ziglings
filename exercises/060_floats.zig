...
//     var foo: f16 = 13.5 * 5;   // No problem, safe type coercion
//     var foo: f16 = 13.5 * 5.0; // No problem, both are floats
//
...
pub fn main() void {
    ...
    var shuttle_weight_ton: f32 = 907.18 * 2200;
    var shuttle_weight_tonne: f32 = shuttle_weight_ton / 1000;

    // By default, float values are formatted in scientific
    // notation. Try experimenting with '{d}' and '{d:.3}' to see
    // how decimal formatting works.
    print("Shuttle liftoff weight: {d:.0}kg == {d:.3}tonne\n", .{ shuttle_weight_ton, shuttle_weight_tonne });
}
